        ...
        <div className='grid grid-rows-[1fr_max-content_1fr_1fr_1fr] gap-[25px] w-[90%] m-auto sm:w-[500px] rounded-[12px] shadow-[0_0_7px_black] p-4 bg-white'>
            ...
            <div className="imageSection w-full flex flex-col gap-2.5 items-center">
                <div className='relative w-32 h-32 rounded-full border-2 border-[#949191] shadow-[0_0_3px_black_inset] overflow-hidden'>
                    ...
                    <div className='absolute bottom-4 right-5 bg-[#0000003b]'>
            ...
            <div className='rounded-[12px] flex items-center p-3 bg-[#b9b7b7] text-[#4b4a4a]'>{userData.username}</div>
            <div className='rounded-[12px] flex items-center p-3 bg-[#b9b7b7] text-[#4b4a4a]'>{userData.name}</div>
